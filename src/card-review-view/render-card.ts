...
import { IMAGE_FORMATS, AUDIO_FORMATS, VIDEO_FORMATS, } from "src/constants";

// slightly modified version of the renderMarkdown function in
// https://github.com/mgmeyers/obsidian-kanban/blob/main/src/KanbanView.tsx
export async function renderMarkdownWrapper (
...
function embedMediaFile (el: HTMLElement, target: TFile) {
  el.innerText = "";
...
async function renderTransclude (
  el: HTMLElement,
  note: TFile,
  link: {
    text: string;
